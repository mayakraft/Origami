...
test("simpleFoldLine, faceOrders, square folding 00", () => {
	...
	//
	//    1
	const result1 = ear.graph.simpleFoldLine(
		graph,
	...
	const result2 = ear.graph.simpleFoldLine(
		graph,
	...
	const result3 = ear.graph.simpleFoldLine(
		graph,
	...
	const result4 = ear.graph.simpleFoldLine(
		graph,
	...
	//  / |  /|  9
	// /5 |/13|
	const result5 = ear.graph.simpleFoldLine(
		graph,
...
test("simpleFoldLine, faceOrders, square folding 01", () => {
	const graph = ear.graph.square();
...
test("simpleFoldLine, faceOrders, square folding 02 with layer solver", () => {
	const graph = ear.graph.square();
	let vertices_coordsFolded;
...
test("simpleFoldLine, faceOrders, square folding, valley, valley", () => {
	const graph = ear.graph.square();
	let vertices_coordsFolded;

	ear.graph.simpleFoldLine(
		graph,
...
test("simpleFoldLine, faceOrders, square folding, valley, mountain", () => {
	const graph = ear.graph.square();
	ear.graph.simpleFoldLine(
		graph,
		{ vector: [3, 1], origin: [0.5, 0.5] },
...
test("simpleFoldLine, faceOrders, square folding", () => {
	const graph = ear.graph.square();
...
test("simpleFoldLine, faceOrders, panels", () => {
...
test("simpleFoldLine, 3D Kabuto", () => {
	...
	// ear.graph.simpleFoldLine(graph, { vector: [1, 0], origin: [0, 0.25] }, "F", 0);
